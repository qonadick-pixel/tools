<div class="modal modal-request-reset-ip">
    <div class="modal-content">
        <div class="mc-header" style="text-align: center">
            <div class="mch-close">
                <i class="fa-solid fa-xmark mchc-close" onclick="openModalRequestResetIP()"></i>
            </div>
            <div class="mch-header">
                <a>Запросы на сброс </a><a style="color: #6b73ff;">IP адреса ключа</a>
            </div>
